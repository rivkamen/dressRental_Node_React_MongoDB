                ...
                <div>
                    ...
                    {existingUser && (
                        <div dir="rtl">
                            ...
                            <Button title='לחץ לאישור' label="המשך עם משתמש זה" onClick={handleProceedWithUser} />
                            <Button title='חזור אחורה' label="חזור אחורה" onClick={handleGoBack} className="p-button-secondary" style={{ marginTop: '10px' }} />
                        </div>
                    )}
...
//                             />
//                             <Button
//                                 label="חזור לשמלה שנבחרה"
//                                 className="p-button-secondary ml-2"
//                                 onClick={() => navigate('/catalog', { state: { dress, chosenDate, size } })}
