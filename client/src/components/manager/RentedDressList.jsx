...
//   const [sortBy, setSortBy] = useState(null);
//   const [searchTerm, setSearchTerm] = useState("");
//   const [first, setFirst] = useState(0);  // הוספתי משתנה לאחסון עמוד התצוגה
//   const [rows, setRows] = useState(12);   // הוספתי משתנה לקביעת מספר השמלות בעמוד
...
//     setFirst(event.first);  // מעדכן את המיקום של העמוד
//     setRows(event.rows);    // מעדכן את מספר השמלות שמוצגות בעמוד
//   };
...
//       <DataTable className="myTab" value={sortedBookings} paginator rows={rows} first={first} dir="rtl">
//         <Column className="myTab" field="dressName" header="שם שמלה" />
//         <Column className="myTab" field="dressSize" header="מידה" />
//         <Column className="myTab" field="userName" header="שוכר/ת" />
//         <Column className="myTab" field="userPhone" header="טלפון" />
...
//       <Paginator first={first} rows={rows} totalRecords={sortedBookings.length} rowsPerPageOptions={[10, 20, 30]} onPageChange={onPageChange} />
//     </div>
//   );
// };
